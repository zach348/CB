...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/DoubleConversion/DoubleConversion.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FBSDKCoreKit/FBSDKCoreKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FBSDKLoginKit/FBSDKLoginKit.framework"
  install_framework "${PODS_ROOT}/Folly/folly.framework"
  install_framework "${PODS_ROOT}/GLog/glog.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GTMAppAuth/GTMAppAuth.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GTMSessionFetcher/GTMSessionFetcher.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GoogleUtilities/GoogleUtilities.framework"
  install_framework "${PODS_ROOT}/MopinionSDK/MopinionSDK.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Protobuf/protobuf.framework"
  install_framework "${PODS_ROOT}/React/React.framework"
  ...
  install_framework "${PODS_ROOT}/react-native-webview/react_native_webview.framework"

...
struct Settings {
  static let settings:[DiffSetting:[Settings]] = [
    ...
    DiffSetting.Hard: [
      Settings(difficulty: DiffSetting.Hard,phase: 1, missesAllowed: 0, requiredStreak: 4, phaseDuration: 50, pauseDelay: 10, pauseError: 2, pauseDuration: 2.5, frequency: 18, toneFile: "tone200hz.wav", targetMeanSpeed: 725, targetSpeedSD: 350, shiftDelay: 4, shiftError: 2, numTargets: 1, targetTexture: "sphere-darkGray", distractorTexture: "sphere-darkGray", borderColor: UIColor.cyan, flashTexture: "sphere-red", alpha: 1),
      Settings(difficulty: DiffSetting.Hard,phase: 2, missesAllowed: 0, requiredStreak: 4,  phaseDuration: 70, pauseDelay: 14, pauseError: 4, pauseDuration: 4, frequency: 14, toneFile: "tone185hz.wav", targetMeanSpeed: 625, targetSpeedSD: 250, shiftDelay: 7, shiftError: 4, numTargets: 2, targetTexture: "sphere-blue1", distractorTexture: "sphere-blue2", borderColor: UIColor.cyan, flashTexture: "sphere-red", alpha: 1),
      Settings(difficulty: DiffSetting.Hard,phase: 3, missesAllowed: 0, requiredStreak: 4, phaseDuration: 90, pauseDelay: 18, pauseError: 4, pauseDuration: 5, frequency: 10, toneFile: "tone170hz.wav", targetMeanSpeed: 500, targetSpeedSD: 150, shiftDelay: 10, shiftError: 6, numTargets: 3, targetTexture: "sphere-purple", distractorTexture: "sphere-magenta", borderColor: UIColor.cyan,flashTexture: "sphere-red", alpha: 1),
      Settings(difficulty: DiffSetting.Hard,phase: 4, missesAllowed: 0, requiredStreak: 4, phaseDuration: 120, pauseDelay: 21, pauseError: 5, pauseDuration: 6, frequency: 8, toneFile: "tone155hz.wav", targetMeanSpeed: 375, targetSpeedSD: 75, shiftDelay: 25, shiftError: 8, numTargets: 4, targetTexture: "sphere-darkTurquoise", distractorTexture: "sphere-green", borderColor: UIColor.cyan, flashTexture: "sphere-white", alpha: 1),
      Settings(difficulty: DiffSetting.Hard,phase: 5, missesAllowed: 0, requiredStreak: 4, phaseDuration: 120, pauseDelay: 24, pauseError: 6, pauseDuration: 8, frequency: 5, toneFile: "tone140hz.wav", targetMeanSpeed: 250, targetSpeedSD: 50, shiftDelay: 40, shiftError: 10, numTargets: 5, targetTexture: "sphere-orange", distractorTexture: "sphere-gray", borderColor: UIColor.cyan, flashTexture: "sphere-white", alpha: 1),
      //messing with duration for dev

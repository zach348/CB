...
struct Settings {
  static let settings:[DiffSetting:[Settings]] = [
    ...
    DiffSetting.Normal: [
       Settings(difficulty: DiffSetting.Normal,phase: 1, missesAllowed: 0, requiredStreak: 3, phaseDuration: 50, pauseDelay: 10, pauseError: 2, pauseDuration: 2.5, frequency: 18, toneFile: "tone200hz.wav", targetMeanSpeed: 550, targetSpeedSD: 200, shiftDelay: 4, shiftError: 2, numTargets: 1, targetTexture: "sp-darkPink-gloss", distractorTexture: "sp-pink-gloss", borderColor: UIColor.cyan, flashTexture: "sp-darkRed-gloss", alpha: 1),
    ...
    DiffSetting.Hard: [
      Settings(difficulty: DiffSetting.Hard,phase: 1, missesAllowed: 0, requiredStreak: 3, phaseDuration: 50, pauseDelay: 10, pauseError: 2, pauseDuration: 2.5, frequency: 18, toneFile: "tone200hz.wav", targetMeanSpeed: 625, targetSpeedSD: 300, shiftDelay: 4, shiftError: 2, numTargets: 1, targetTexture: "sp-darkPink-gloss", distractorTexture: "sp-pink-gloss", borderColor: UIColor.cyan, flashTexture: "sp-darkRed-gloss", alpha: 1),

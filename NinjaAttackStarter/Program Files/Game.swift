...
class Game {
  ...
  static var respSettingsArr:[RespSettings] = [
    RespSettings(phase: 7, phaseDuration: 60, frequency: 2.5, inDuration: 4.5, inWait: 2, outDuration: 7, outWait: 3, moveToCenterDuration: 8.5, moveCenterWait: 2),
    RespSettings(phase: 8, phaseDuration: 90, frequency: 1.5, inDuration: 6, inWait: 3, outDuration: 10, outWait: 4.5, moveToCenterDuration: 8.5, moveCenterWait: 2),
    RespSettings(phase: 9, phaseDuration: 999, frequency: 1.5, inDuration: 7.5, inWait: 4, outDuration: 12, outWait: 6, moveToCenterDuration: 10, moveCenterWait: 2)
  ]

...
class Game {
  ...
  static var settingsArr:[Settings] = [
    ...
    Settings(phase: 5, phaseDuration: 120, pauseDelay: 35, pauseError: 8, pauseDuration: 6, frequency: 6, toneFile: "tone140hz.wav", targetMeanSpeed: 150, targetSpeedSD: 25, shiftDelay: 40, shiftError: 10, numTargets: 5, targetTexture: "sphere-aqua", distractorTexture: "sphere-gray", flashTexture: "sphere-white", alpha: 1),
    //messing with duration for dev
    Settings(phase: 6, phaseDuration: 120, pauseDelay: 40, pauseError: 10, pauseDuration: 7, frequency: 4.5, toneFile: "tone140hz.wav", targetMeanSpeed: 50, targetSpeedSD: 0, shiftDelay: 50, shiftError: 15, numTargets: 6, targetTexture: "sphere-orange", distractorTexture: "sphere-black", flashTexture: "sphere-white", alpha: 1),

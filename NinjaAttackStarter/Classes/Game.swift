...
class Game {
  ...
  static var settingsArr:[Settings] = [
    ...
    Settings(phase: 6, phaseDuration: 120, pauseDelay: 40, pauseError: 10, pauseDuration: 7, frequency: 4.5, toneFile: "tone140hz.wav", targetMeanSpeed: 50, targetSpeedSD: 0, shiftDelay: 50, shiftError: 15, numTargets: 6, targetTexture: "sphere-bloodOrange", distractorTexture: "sphere-black", flashTexture: "sphere-white", alpha: 1),
    //Final settings is a dummy phase...
    Settings(phase: 7, phaseDuration: 900, pauseDelay: 40, pauseError: 10, pauseDuration: 7, frequency: 3.5, toneFile: "tone140hz.wav", targetMeanSpeed: 0, targetSpeedSD: 0, shiftDelay: 50, shiftError: 15, numTargets: 6, targetTexture: "sphere-bloodOrange", distractorTexture: "sphere-black", flashTexture: "sphere-orange", alpha: 1)
  ]
